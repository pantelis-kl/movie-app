...
export default function CrewComp({id}){
        ...
        {data && 
          (
            ...
            {producers.map(p=>
             ...
             hover:bg-white/8 hover:border-white/20 transition-all duration-500 group shadow-2xl" key={p.id}>
                    {p.profile_path?
            ...
            {writers.map(w=>
                <div className="flex flex-col p-2 gap-3 min-w-30 sm:min-w-35 lg:min-w-40 rounded-2xl items-center justify-center bg-white/3 backdrop-blur-xl border border-white/10 
             hover:bg-white/8 hover:border-white/20 transition-all duration-500 group shadow-2xl" key={w.id}>
                    {w.profile_path?
                      <img src={`https://image.tmdb.org/t/p/w185/${w.profile_path}`} 
                      className="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full object-cover border-2 border-white/10 p-1 shadow-2xl transition-transform duration-500 group-hover:scale-105"/>  
                    :
                    <div className="w-24 h-24 lg:w-30 lg:h-30 rounded-full flex flex-col items-center justify-center 
                  bg-white/3 backdrop-blur-md border border-white/10 shadow-inner group">
            ...
            {directors.map(d=>
                <div className="flex flex-col p-2 gap-3 min-w-30 sm:min-w-35 lg:min-w-40 rounded-2xl items-center justify-center bg-white/3 backdrop-blur-xl border border-white/10 
             hover:bg-white/8 hover:border-white/20 transition-all duration-500 group shadow-2xl" key={d.id}>
                    {d.profile_path?
                      <img src={`https://image.tmdb.org/t/p/w185/${d.profile_path}`} 
                      className="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-full object-cover border-2 border-white/10 p-1 shadow-2xl transition-transform duration-500 group-hover:scale-105"/>  
                    :
                    <div className="w-24 h-24 lg:w-30 lg:h-30 rounded-full flex flex-col items-center justify-center 
                  bg-white/3 backdrop-blur-md border border-white/10 shadow-inner group">
