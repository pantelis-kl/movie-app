...
export default function ReleaseComp({ data, classname, loading }) {
  return (
    <>
      {loading ? (
        <div
        ...
        >
          <span className="text-[10px] w-30">
            <Skeleton />
          </span>
          <h3 className="text-xl w-25">
            <Skeleton />
          </h3>
          <h3 className="text-[23px] w-25 lg:w-30 sm:text-[26px] lg:text-3xl translate-y-5">
            <Skeleton />
          </h3>
        </div>
      ) : (
        ...
        >
          ...
          <h3 className="text-white text-[23px] sm:text-[26px] lg:text-3xl translate-y-5 font-mono">
